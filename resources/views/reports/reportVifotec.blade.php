...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="float-left">
            <h2>Bằng khen VIFOTEC</h2>
        </div>
    </div>
</div>

<form action="/reports/Vifotec/download" method="GET">
    <!-- @csrf -->
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                <!-- <strong>Giải:</strong> -->
                {!! Form::select('medal_id', $medals??[], 5, array('required', 'placeholder' => 'Chọn giải...', 'class' => 'form-control', 'id'=>'medal-id')) !!}
            </div>
        </div>
    ...
    function print(p) {
        ...
        if (id) {
            $("<iframe class='printpage'>")
                .hide()
                .attr("src", `/reports/Vifotec/download?medal_id=${id}&print=${p}`)
                .appendTo("body");
        } else {
