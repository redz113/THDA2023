...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="float-left">
            <h2>Giấy chứng nhận học sinh đạt giải</h2>
        </div>
    </div>
</div>

<form action="/reports/certificate/download" method="GET">
    <!-- @csrf -->
    <div class="row">
        ...
        <!-- <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('user_id', $users??[], 0, array( 'placeholder' => 'Chọn đơn vị dự thi...', 'class' => 'form-control')) !!}
            </div>
        </div> -->
        <!-- <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
    ...
    function print(p) {
        ...
        // if (id) {
            $("<iframe class='printpage'>")
                ...
                .attr("src", `/reports/certificate/download?print=${p}`)
                .appendTo("body");
        // } else {
