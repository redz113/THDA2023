...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="float-left">
            <h2>Giấy chứng nhận giáo viên hướng dẫn học sinh đạt giải</h2>
        </div>
    </div>
</div>

<form action="/reports/certificateGV/download" method="GET">
    <!-- @csrf -->
    <div class="row">

        <!-- <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                {!! Form::select('medal_id', $medals??[], 0, array('required', 'placeholder' => 'Chọn giải...', 'class' => 'form-control', 'id'=>'medal-id')) !!}
            </div>
        </div> -->
...
<script>
    function print(p) {
        ...
        $("<iframe class='printpage'>")
            .hide()
            .attr("src", `/reports/certificateGV/download?print=${p}`)
            .appendTo("body");
        // } else {
