...
<head>
    ...
    <style>
        ...
        * {
        ...
        .wrapper {
            /* background-image: url("{{ storage_path('img/TWD.png') }}"); */
            height: 100%;
            width: 100%;
...
<body>
    ...
    <div class="wrapper">
        ...
        <k class="name">Nhóm học sinh: <b style="text-transform: uppercase;">{{$research['student_1'][0]}}</b>, <b style="text-transform: uppercase;">{{$research['student_2'][0]}}</b></k>
        @else
